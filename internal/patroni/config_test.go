...
func TestAuthConfigYAML(t *testing.T) {
	yaml, err := authConfigYAML("daisy", "she$'a'g00d'gRl")
	assert.NilError(t, err)
	assert.Equal(t, yaml, strings.TrimSpace(`
# Generated by postgres-operator. DO NOT EDIT.
# Your changes will not be saved.
postgresql:
  authentication:
    replication:
      password: she$'a'g00d'gRl
      username: daisy
    rewind:
      password: she$'a'g00d'gRl
      username: daisy
...
func TestInstanceConfigFiles(t *testing.T) {
	...
	s1 := &v1.Secret{ObjectMeta: metav1.ObjectMeta{Name: "s1"}}

	projections := instanceConfigFiles(cm1, cm2, s1)
