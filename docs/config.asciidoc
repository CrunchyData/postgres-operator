...
Namespace:  demo
Cluster:
  CCPImageTag:  centos7-9.6.6-1.7.0
  Port:  5432
...
|Cluster.CCPImageTag        |newly created containers will be based on this image version (e.g. centos7-9.6.6-1.7.0), unless you override it using the --ccp-image-tag command line flag
