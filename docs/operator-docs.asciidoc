...
it on a running Kubernetes cluster will find the Quickstart
...
....
docker pull crunchydata/crunchy-postgres:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-backup:centos7-10.1-1.7.1
docker pull crunchydata/crunchy-upgrade:centos7-10.1-1.7.1
....
...
is located in the repo at *example/pgo-bash-completion*. To use it:
....
