...
|CCPImageTag        |newly created containers will be based on this image version (e.g. centos7-12.3-4.2.3), unless you override it using the --ccp-image-tag command line flag
