...
| `ccp_image_tag` | centos7-12.3-4.4.0-beta.1 | **Required** | Configures the image tag (version) used when creating containers from Crunchy Container Suite. |
...
| `pgo_client_version` | 4.4.0-beta.1 | **Required** |  |
...
| `pgo_image_tag` | centos7-4.4.0-beta.1 | **Required** | Configures the image tag used when creating containers for the Crunchy PostgreSQL Operator (apiserver, operator, scheduler..etc) |
