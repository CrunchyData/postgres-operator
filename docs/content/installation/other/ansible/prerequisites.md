...
All necessary files (inventory, main playbook and roles) can be found in the
...
| `namespace_mode`                  | dynamic     | **Required** | Determines which namespace permissions are assigned to the PostgreSQL Operator using a ClusterRole. Options: `dynamic`, `readonly`, and `disabled`|
