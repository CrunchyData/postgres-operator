 ...
 * create a database (*pgo create database testdb*)
 * show a database (*pgo show database testdb*)
 * show all databases (*pgo show database all*)
 * backup a database (*pgo create backup testdb*)
 * show backup of database (*pgo show backup testdb*)
 * show backup of database and list pvc(*pgo show backup testdb --show-pvc=true*)
 * delete a database (*pgo delete database testdb*)
 * restore a database (*pgo create database testdb2 --backup-pvc=db1-backup-pvc --backup-path=db1-backups/2017-05-18-14-37-47*)
 ...
 * minor upgrade a database (*pgo create upgrade testdb*)
 * major upgrade a database (*pgo create upgrade testdb --upgrade-type=major*)
