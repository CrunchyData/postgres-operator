...
....
docker pull crunchydata/lspvc:centos7-1.3.2
docker pull crunchydata/postgres-operator:centos7-1.3.2
....
...
....
cd $HOME
wget https://github.com/CrunchyData/postgres-operator/releases/download/v1.3.2/postgres-operator.1.3.2.tar.gz
tar xvzf ./postgres-operator.1.3.2.tar.gz
....
