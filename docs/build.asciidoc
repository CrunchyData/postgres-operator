...
In version 1.6 of the Operator, modify your $HOME/.pgo.yaml
file by setting the Namespace configuration setting to your
new namespace *demo*, as follows:

....
Namespace:  demo
....

likewise, specify your *CO_NAMESPACE* environment variable as *demo*
