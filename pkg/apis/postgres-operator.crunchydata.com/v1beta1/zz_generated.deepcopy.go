...
func (in *ExistingVolume) DeepCopy() *ExistingVolume {
	...
	out := new(ExistingVolume)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExistingVolumes) DeepCopyInto(out *ExistingVolumes) {
	*out = *in
	if in.ExistingPGDataVolume != nil {
		in, out := &in.ExistingPGDataVolume, &out.ExistingPGDataVolume
		*out = new(ExistingVolume)
		**out = **in
	}
	if in.ExistingPGWALVolume != nil {
		in, out := &in.ExistingPGWALVolume, &out.ExistingPGWALVolume
		*out = new(ExistingVolume)
		**out = **in
	}
	if in.ExistingPGBackRestVolume != nil {
		in, out := &in.ExistingPGBackRestVolume, &out.ExistingPGBackRestVolume
		*out = new(ExistingVolume)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExistingVolumes.
func (in *ExistingVolumes) DeepCopy() *ExistingVolumes {
	if in == nil {
		return nil
	}
	out := new(ExistingVolumes)
