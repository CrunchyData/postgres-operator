...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PGMajorUpgrade) DeepCopyInto(out *PGMajorUpgrade) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = new(Metadata)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PGMajorUpgrade.
func (in *PGMajorUpgrade) DeepCopy() *PGMajorUpgrade {
	if in == nil {
		return nil
	}
	out := new(PGMajorUpgrade)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PostgresClusterStatus) DeepCopyInto(out *PostgresClusterStatus) {
	*out = *in
	...
	if in.PGUpgrade != nil {
		in, out := &in.PGUpgrade, &out.PGUpgrade
		*out = new(PGUpgradeStatus)
		(*in).DeepCopyInto(*out)
	}
	out.Proxy = in.Proxy
