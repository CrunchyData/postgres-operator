...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PGBackRestManualBackupStatus) DeepCopyInto(out *PGBackRestManualBackupStatus) {
	*out = *in
	if in.StartTime != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PGBackRestManualBackupStatus.
func (in *PGBackRestManualBackupStatus) DeepCopy() *PGBackRestManualBackupStatus {
	if in == nil {
		return nil
	}
	out := new(PGBackRestManualBackupStatus)
	in.DeepCopyInto(out)
	return out
}
