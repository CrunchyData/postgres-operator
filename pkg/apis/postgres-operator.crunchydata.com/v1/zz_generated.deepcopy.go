...
func (in *PGBackRestArchive) DeepCopyInto(out *PGBackRestArchive) {
	*out = *in
	in.PGBackRestArchive.DeepCopyInto(&out.PGBackRestArchive)
}
...
func (in *PGBouncerPodSpec) DeepCopyInto(out *PGBouncerPodSpec) {
	*out = *in
	in.PGBouncerPodSpec.DeepCopyInto(&out.PGBouncerPodSpec)
}
...
func (in *PostgresInstanceSetStatus) DeepCopyInto(out *PostgresInstanceSetStatus) {
	*out = *in
	...
	if in.DesiredPGWALVolume != nil {
		in, out := &in.DesiredPGWALVolume, &out.DesiredPGWALVolume
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
