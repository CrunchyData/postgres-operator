...
We use the [controller-gen] tool to produce [CRD]s with [schemas](validation.md) that match the Go types.
...
metadata:
  name: "ideas.example.com" # {plural}.{group}
spec:
...
venn
  ...
  sets Group,Version  label: apiVersion
...
Version v1beta1 is compatible with Kubernetes 1.30, OpenShift 4.14, and later.
Version v1 uses newer CRD features and requires Kubernetes 1.30, OpenShift 4.17, and later.
