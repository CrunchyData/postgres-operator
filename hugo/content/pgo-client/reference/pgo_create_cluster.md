...
```
  ...
  -s, --secret-from string                The cluster name to use when restoring secrets.
      ...
      --tablespace strings                A list of extra mounts to create for tablespaces. The format is a comma seperated list of <mountName>=<storageConfig>
```
...
###### Auto generated by spf13/cobra on 1-Mar-2020
