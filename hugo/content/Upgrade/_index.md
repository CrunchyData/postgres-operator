...
In this example, we are upgrading a cluster from PostgreSQL 11.5 to 11.6 using the `crunchy-postgres:centos7-11.6-4.3.0` container:

`pgo upgrade mycluster --ccp-image-tag=centos7-11.6-4.3.0`
