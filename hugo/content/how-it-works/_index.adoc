...
See link:https://crunchydata.github.io/crunchy-containers/stable/getting-started/kubernetes-and-openshift/#_metrics_and_performance[the crunchy-containers Metrics example] for more details on setting up the *crunchy-metrics* solution.
