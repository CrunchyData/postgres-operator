...
---
title: "PGO YAML"
Latest Release: 4.0.0-rc13 {docdate}
draft: false
weight: 3
---
...
|CCPImageTag        |newly created containers will be based on this image version (e.g. centos7-11.3-2.4.0-rc10), unless you override it using the --ccp-image-tag command line flag
