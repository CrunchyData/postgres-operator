...
|CCPImageTag        |newly created containers will be based on this image version (e.g. centos7-12.1-4.1.1), unless you override it using the --ccp-image-tag command line flag
