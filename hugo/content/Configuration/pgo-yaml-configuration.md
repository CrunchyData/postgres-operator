...
|CCPImageTag        |newly created containers will be based on this image version (e.g. centos7-11.2-2.4.0-rc4), unless you override it using the --ccp-image-tag command line flag
