...
CONTAINER_NAME='pgo-ssl-replica-container'
...
${PGO_CMD?} delete configmap pgo-replica-ssl-config -n ${PGO_NAMESPACE}

${PGO_CMD?} create --namespace=${PGO_NAMESPACE?} configmap pgo-replica-ssl-config \
...
sslmode=verify-full&\
sslrootcert=$PGOROOT/examples/primary-replica-custom-ssl/certs/ca.crt&\
sslcrl=$PGOROOT/examples/primary-replica-custom-ssl/certs/ca.crl&\
sslcert=$PGOROOT/examples/primary-replica-custom-ssl/certs/client.crt&\
sslkey=$PGOROOT/examples/primary-replica-custom-ssl/certs/client.key\""
echo ""
