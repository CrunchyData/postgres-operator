...
The Operator should show the new cluster started:
	...
	labels : pg-cluster=fromcrd pgo-backrest=false primary=true archive=false deployment-name=fromcrd name=fromcrd current-primary=fromcrd pgo-version=3.5.2 archive-timeout=60 crunchy-pgbadger=false crunchy_collect=false 
