...
The Operator should show the new cluster started:
    ...
    cluster : fromcrd (centos7-12.1-4.1.2)
	...
	labels : pg-cluster=fromcrd pgo-backrest=false primary=true archive=false deployment-name=fromcrd name=fromcrd current-primary=fromcrd pgo-version=4.1.2 archive-timeout=60 crunchy-pgbadger=false crunchy_collect=false
