...
The Operator should show the new cluster started:
    ...
    cluster : fromcrd (centos7-11.3-2.4.0-rc9)
	...
	labels : pg-cluster=fromcrd pgo-backrest=false primary=true archive=false deployment-name=fromcrd name=fromcrd current-primary=fromcrd pgo-version=4.0.0-rc12 archive-timeout=60 crunchy-pgbadger=false crunchy_collect=false 
