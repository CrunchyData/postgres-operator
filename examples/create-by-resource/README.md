...
The Operator should show the new cluster started:
    ...
    cluster : fromcrd (centos7-12.3-4.4.0-beta.1)
	...
	labels : pg-cluster=fromcrd pgo-backrest=false primary=true archive=false deployment-name=fromcrd name=fromcrd current-primary=fromcrd pgo-version=4.4.0-beta.1 archive-timeout=60 crunchy-pgbadger=false crunchy_collect=false
