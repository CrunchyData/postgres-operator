...
To build and deploy the Operator on your Kubernetes system, follow the instructions documented on the link:docs/operator-docs.asciidoc[Build and Install] page.
